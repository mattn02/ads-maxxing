...
- No vision classifier or browser-action fallback runs yet. Unstructured photos do not gain eligibility from resemblance or model confidence. The owner can explicitly assign a known product photo; exact variant assignment still requires structured association.
