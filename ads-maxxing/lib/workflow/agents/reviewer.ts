...
Text and legibility: every required headline, CTA, researched price, complete confirmed offer, and restriction must be correct, complete, and readable. Fail missing, altered, invented, duplicated, obscured, or materially illegible required copy, generated scene text, or invented logos.
